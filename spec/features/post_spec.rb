...
describe 'navigate' do
    ...
    it 'has a scope so that onlypost creators their posts' do
    	post1 = Post.create(date: Date.today, rationale: "qwerty", user_id: @user.id)
      post2 = Post.create(date: Date.today, rationale: "qwerty", user_id: @user.id)
